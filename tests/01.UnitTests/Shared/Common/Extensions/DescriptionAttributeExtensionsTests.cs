...
//namespace Pertamina.SolutionTemplate.UnitTests.Shared.Common.Extensions;
...
//    [Theory]
//    [InlineData(SeverityLevel.Low, "1 - Low")]
//    [InlineData(SeverityLevel.Medium, "2 - Medium")]
//    [InlineData(SeverityLevel.High, "3 - High")]
//    [InlineData(SeverityLevel.Critical, "4 - Critical")]
//    public void Should_Get_Enum_Value_Description(SeverityLevel severityLevel, string expectedDescription)
//    {
//        // Act
//        var description = severityLevel.GetDescription();
