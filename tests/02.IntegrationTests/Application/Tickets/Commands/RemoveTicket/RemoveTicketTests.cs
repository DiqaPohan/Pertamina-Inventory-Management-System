...
//using Pertamina.SolutionTemplate.Application.Tickets.Commands.RemoveTicket;
...
//namespace Pertamina.SolutionTemplate.IntegrationTests.Application.Tickets.Commands.RemoveTicket;
...
//    public RemoveTicketTests(ApplicationFixture fixture)
//    {
//        _fixture = fixture;
...
//    [Fact]
//    public async Task Should_Remove_Ticket()
//    {
//        #region Create App
...
//        _fixture.RunAsUser(UsernameFor.TicketingSupportEngineer1, PositionIdFor.AnalystApplicationSupport);

//        var removeTicketCommand = new RemoveTicketCommand
//        {
//            TicketId = ticket.Id,
//            Message = "Remove Ticket Message Line 1\nRemove Ticket Message Line 2\nRemove Ticket Message Line 3"
//        };

//        await _fixture.SendAsync(removeTicketCommand);

//        ticket = await _fixture.FindAsync<Ticket>(ticket.Id);

//        ticket!.Status.Should().Be(TicketStatus.Removed);
//        #endregion Remove Ticket
//    }
//}
