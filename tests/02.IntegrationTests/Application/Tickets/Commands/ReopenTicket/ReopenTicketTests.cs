...
//using Pertamina.SolutionTemplate.Application.Tickets.Commands.ReopenTicket;
//using Pertamina.SolutionTemplate.Application.Tickets.Commands.ResolveTicket;
...
//namespace Pertamina.SolutionTemplate.IntegrationTests.Application.Tickets.Commands.ReopenTicket;

//[Collection(nameof(ApplicationFixture))]
//public class ReopenTicketTests
//{
//    private readonly ApplicationFixture _fixture;

//    public ReopenTicketTests(ApplicationFixture fixture)
//    {
//        _fixture = fixture;
...
//        _fixture.RunAsUser(UsernameFor.TicketingSupportEngineer2, PositionIdFor.JrAnalystApplicationSupport2);
...
//        #region Resolve Ticket
//        _fixture.RunAsUser(UsernameFor.TicketingSupportEngineer2, PositionIdFor.JrAnalystApplicationSupport2);

//        var resolveTicketCommand = new ResolveTicketCommand
//        {
//            TicketId = ticket.Id,
//            Message = "Resolve Ticket Message Line 1\nResolve Ticket Message Line 2\nResolve Ticket Message Line 3"
//        };

//        await _fixture.SendAsync(resolveTicketCommand);

//        ticket = await _fixture.FindAsync<Ticket>(ticket.Id);

//        ticket!.Status.Should().Be(TicketStatus.Resolved);
//        #endregion Resolve Ticket

//        #region Reopen Ticket
//        _fixture.RunAsUser(UsernameFor.TicketingUser1);

//        var reopenTicketCommand = new ReopenTicketCommand
//        {
//            TicketId = ticket.Id,
//            Message = "Reopen Ticket Message Line 1\nReopen Ticket Message Line 2\nReopen Ticket Message Line 3"
//        };

//        await _fixture.SendAsync(reopenTicketCommand);

//        ticket = await _fixture.FindAsync<Ticket>(ticket.Id);

//        ticket!.Status.Should().Be(TicketStatus.Reopened);
//        #endregion Reopen Ticket
//    }
//}
