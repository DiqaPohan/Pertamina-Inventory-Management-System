...
namespace Pertamina.SolutionTemplate.Infrastructure.UserProfile.IS4IM;

public class IS4IMUserProfileHealthCheck : IHealthCheck
{
    private readonly RestClient _restClient;

    public IS4IMUserProfileHealthCheck(string healthCheckUrl)
    {
