...
//using Pertamina.SolutionTemplate.Infrastructure.Storage.AzureBlob;
using Pertamina.SolutionTemplate.Infrastructure.Storage.LocalFolder;
using Pertamina.SolutionTemplate.Infrastructure.Storage.None;
using Pertamina.SolutionTemplate.Shared.Common.Constants;

namespace Pertamina.SolutionTemplate.Infrastructure.Storage;
