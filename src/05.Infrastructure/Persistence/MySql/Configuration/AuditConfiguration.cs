...
using Pertamina.SolutionTemplate.Infrastructure.Persistence.MySql.Constants;
using Pertamina.SolutionTemplate.Shared.Audits.Constants;

namespace Pertamina.SolutionTemplate.Infrastructure.Persistence.MySql.Configuration;

public class AuditConfiguration : IEntityTypeConfiguration<Audit>
{
    public void Configure(EntityTypeBuilder<Audit> builder)
    {
        builder.ToTable(nameof(ISolutionTemplateDbContext.Audits));
