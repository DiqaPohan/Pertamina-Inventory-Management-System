...
//public class HistoricalAppPhaseConfiguration : IEntityTypeConfiguration<HistoricalAppPhase>
//{
//    public void Configure(EntityTypeBuilder<HistoricalAppPhase> builder)
//    {
//        builder.ToTable(nameof(ISolutionTemplateDbContext.HistoricalAppPhase), nameof(SolutionTemplate));
