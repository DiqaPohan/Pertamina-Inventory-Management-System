...
public class ApplicationLicenseConfiguration : IEntityTypeConfiguration<ApplicationLicense>
{
    public void Configure(EntityTypeBuilder<ApplicationLicense> builder)
    {
        builder.ToTable(nameof(ISolutionTemplateDbContext.ApplicationLicense), nameof(SolutionTemplate));
