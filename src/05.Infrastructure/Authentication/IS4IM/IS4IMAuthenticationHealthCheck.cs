...
namespace Pertamina.SolutionTemplate.Infrastructure.Authentication.IS4IM;

public class IS4IMAuthenticationHealthCheck : IHealthCheck
{
    private readonly RestClient _restClient;

    public IS4IMAuthenticationHealthCheck(string healthCheckUrl)
    {
