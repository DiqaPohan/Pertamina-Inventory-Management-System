using Pertamina.SolutionTemplate.Bsui.Services.Geolocation.Darnton;
using Pertamina.SolutionTemplate.Bsui.Services.Geolocation.None;

namespace Pertamina.SolutionTemplate.Bsui.Services.Geolocation;
