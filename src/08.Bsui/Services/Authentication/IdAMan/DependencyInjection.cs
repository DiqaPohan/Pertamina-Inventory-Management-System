...
using Pertamina.SolutionTemplate.Bsui.Services.Authentication.Constants;
using Pertamina.SolutionTemplate.Bsui.Services.Authentication.Extensions;
using Pertamina.SolutionTemplate.Bsui.Services.FrontEnd;

namespace Pertamina.SolutionTemplate.Bsui.Services.Authentication.IdAMan;
    ...
    public static IServiceCollection AddIdAManAuthentication(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services
            ...
            .AddOpenIdConnect(OpenIdConnectDefaults.AuthenticationScheme, options =>
            {
                ...
                options.Scope.Add(IdAManScopes.UserReadAll);
