using Pertamina.SolutionTemplate.Bsui.Services.Logging.None;
using Pertamina.SolutionTemplate.Bsui.Services.Logging.Serilog;
using Pertamina.SolutionTemplate.Shared.Common.Constants;

namespace Pertamina.SolutionTemplate.Bsui.Services.Logging;
