...
public static class OpenIdConnectExtensions
{
    ...
    {
        return builder.AddOpenIdConnect(OpenIdConnectDefaults.AuthenticationScheme, _ => { });
    }
    ...
    {
        return builder.AddOpenIdConnect(OpenIdConnectDefaults.AuthenticationScheme, configureOptions);
    }
    ...
    {
        return builder.AddOpenIdConnect(authenticationScheme, OpenIdConnectDefaults.DisplayName, configureOptions);
    }
