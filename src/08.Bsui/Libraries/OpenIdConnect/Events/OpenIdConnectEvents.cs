...
public class OpenIdConnectEvents : RemoteAuthenticationEvents
{
    ...
    {
        return OnRedirectToIdentityProviderForSignOut(context);
    }
    ...
    {
        return OnSignedOutCallbackRedirect(context);
    }
    ...
    {
        return OnTokenResponseReceived(context);
    }
    ...
    {
        return OnUserInformationReceived(context);
    }
}
