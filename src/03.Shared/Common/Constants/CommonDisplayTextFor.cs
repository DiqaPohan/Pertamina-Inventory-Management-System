...
public static class CommonDisplayTextFor
{
    ...
    public const string BuildingBlock = @"By Business Building Block";
    public const string NonTabularView = nameof(BuildingBlock);
    public const string ListApps = @"By List Of Applications";
    public const string TabularView = nameof(ListApps);
    public const string RequestAndApproval = @"Request And Approval";
    ...
    public const string AddDraftHistoricalPhase = nameof(AddDraftHistoricalPhase);
    ...
    public const string ViewDraftCatalog = nameof(ViewDraftCatalog);
    public const string ViewDraftHistoricalPhase = nameof(ViewDraftHistoricalPhase);
