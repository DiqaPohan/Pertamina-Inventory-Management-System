...
public class AddDraftCatalogRequest
{
    ...
    [OpenApiContentType(ContentTypes.TextPlain)]
    public DateTime Start_Rationalization { get; set; }
    [OpenApiContentType(ContentTypes.TextPlain)]
    public string? Start_Rationalization_Str { get; set; }
    [OpenApiContentType(ContentTypes.TextPlain)]
    public DateTime Start_Sunset { get; set; }
    [OpenApiContentType(ContentTypes.TextPlain)]
    public string? Start_Sunset_Str { get; set; }
    [OpenApiContentType(ContentTypes.TextPlain)]
...
public class AddDraftCatalogRequestValidator : AbstractValidator<AddDraftCatalogRequest>
{

    public AddDraftCatalogRequestValidator()
    {
